...
def run():
    ...
    equipo.objects.update_or_create(nombre_equipo="Karmine Corp GC", defaults={"jugador1":"Jiex", "jugador2":"alkyia", "jugador3":"Glance", "jugador4":"safiaa", "jugador5":"anesilia","racha":6,"imagen_equipo":"imagenes/logo equipos/Karmine_Corp_logo.png"})
    ...
    equipo.objects.update_or_create(nombre_equipo="GIANTX GC", defaults={"jugador1":"Nami", "jugador2":"sarah", "jugador3":"eva", "jugador4":"ness", "jugador5":"Smurfette","racha":0,"imagen_equipo":"imagenes/logo equipos/GIANTX_logo.png"})
